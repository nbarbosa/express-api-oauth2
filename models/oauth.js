...
var authorizedClientIds = [process.env.APP_CLIENT_ID];
...
model.saveAccessToken = function(token, clientId, expires, user, callback) {
  console.log('in saveAccessToken (token: ' + token + ', clientId: ' + clientId + ', userId: ' + user._id + ', expires: ' + expires + ')');
...
model.saveRefreshToken = function(token, clientId, expires, user, callback) {
  console.log('in saveRefreshToken (token: ' + token + ', clientId: ' + clientId + ', userId: ' + user._id + ', expires: ' + expires + ')');
